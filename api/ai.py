...
- If the user asks for Gmail search/list/label/draft/thread or calendar actions, explain those are not available yet on this branch and offer a nearby alternative using the available primitives only.
